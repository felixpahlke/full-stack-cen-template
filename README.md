...
You are viewing the `oauth-proxy-custom-ui` flavour: shadcn/ui with an OAuth/OIDC authentication
boundary.
...
- [Development, OAuth configuration, testing, commands, and troubleshooting](.docs/development.md)
