...
- Wrong public path: this flavor exposes separate backend and frontend applications. Compare the
  generated URLs and persisted `VITE_API_URL`/CORS values with the application details.
