...
def factory_settings() -> Settings:
    return Settings(  # type: ignore[call-arg]
        _env_file=None,
        PROJECT_NAME="No-database compatibility tests",
        API_KEY="no-database-test-api-key",
...
def test_legacy_settings_and_logging_use_factories(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    settings = factory_settings()
    ...
    exec("from app.core.config import settings", namespace)
