    ...
    *,
    ...
    return {
        **os.environ,
        ...
        "FIRST_SUPERUSER": "startup-admin@example.com",
        "FIRST_SUPERUSER_PASSWORD": "migration-startup-test-password",
        "SIGNUP_ACCESS_PASSWORD": "migration-startup-signup-password",
...
def _assert_database_ready(database_url: str, *, user_count: int = 1) -> None:
    ...
    try:
        with engine.connect() as connection:
            ...
            assert connection.scalar(text('SELECT count(*) FROM "user"')) == user_count
    finally:
        engine.dispose()
