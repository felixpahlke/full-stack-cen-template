...
This is the shadcn/ui, oauth2-proxy flavour of the FastAPI/SQLModel template. Preserve its proxy
authentication boundary, PostgreSQL backend, custom UI, and separate production images.
