...
This is the custom shadcn/ui, oauth2-proxy branch. Preserve the proxy authentication model, opaque
...
- Preserve the existing shadcn/ui primitives and Tailwind CSS styling.
