...
This branch is the Carbon UI, local-authentication variant of the template. Keep changes small,
...
- Use Carbon components and tokens; Tailwind is for layout/spacing and the existing token bridge.
