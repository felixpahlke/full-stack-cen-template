...
The JavaScript packages now use one pnpm workspace and one root lockfile. After updating an older
npm-based checkout, remove the old installs and lockfiles before installing once at the root:
